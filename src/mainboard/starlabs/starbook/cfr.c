...
static struct sm_object fan_mode = SM_DECLARE_ENUM({
	.opt_name	= "fan_mode",
	.ui_name	= "Fan Mode",
...
static struct sm_object max_charge = SM_DECLARE_ENUM({
	.opt_name	= "max_charge",
...
static struct sm_object me_state = SM_DECLARE_ENUM({
	.opt_name	= "me_state",
...
static struct sm_object microphone = SM_DECLARE_BOOL({
	.opt_name	= "microphone",
	.ui_name	= "Microphone",
...
static struct sm_object pci_hot_plug = SM_DECLARE_BOOL({
...
#if CONFIG(DRIVERS_INTEL_USB4_RETIMER)
static struct sm_object thunderbolt = SM_DECLARE_BOOL({
...
static struct sm_object me_state_counter = SM_DECLARE_NUMBER({
