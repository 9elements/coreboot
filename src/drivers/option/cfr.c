...
{
	return write_cfr_varchar(current, string, CFR_TAG_VARCHAR_DEF_VALUE);
}
...
{
	return write_numeric_option(current, CFR_TAG_OPTION_ENUM, g_object_id++,
...
{
	return write_numeric_option(current, CFR_TAG_OPTION_NUMBER, g_object_id++,
...
{
	return write_numeric_option(current, CFR_TAG_OPTION_BOOL, g_object_id++,
